              ...
              <div className="space-y-8 text-gray-700">
                ...
                <section id="interpretation" className="scroll-mt-24">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mt-4">
                    ...
                    <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Agrikrishi Farms, Indore, India.</li>
                    ...
                    <li><strong>Website</strong> refers to Agrikrishi Farms, accessible from (to be provided)</li>
                ...
                <section id="how-we-use" className="scroll-mt-24">
                  ...
                  <p>
                    We use your Personal Data to provide you the product and services you request, communicate with you, improve your experience on the Agrikrishi Farms Sites, generally improve our products and services and for other internal business purposes. These uses may also include the recording, organization, structuring, storage, adaptation or alteration, retrieval, consultation, use, disclosure by transmission, dissemination or otherwise making available, alignment or combination, restriction, erasure or destruction of Personal Data. The Personal Data we collect about you may be stored, and later on archived, only for so long as reasonably necessary for the purposes set out above, in accordance with applicable laws.
                  </p>

                  <h3 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#81ba00' }}>Information You Provide</h3>
                  <p>
                    You generally do not have to register for a service or program to receive much of the information available through Agrikrishi Farms Sites. However, some of our content is available only to registered or identified users and will require you to set up a profile or provide specific information about yourself in order to provide you the service.
                  </p>

                  <h3 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#81ba00' }}>Personal Data You Provide When Visiting Agrikrishi Farms Sites</h3>
                  <p>
                    Agrikrishi Farms collects Personal Data that you provide on Agrikrishi Farms Sites, for example, when purchasing a services, to receive marketing products and information, contact Agrikrishi Farms customer service, or respond to Agrikrishi Farms questionnaires or surveys. This could include:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <section id="contact" className="scroll-mt-24">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mt-4">
                    ...
                    <li>By visiting this page on our website: <a href="/contact" className="underline" style={{ color: '#81ba00' }} onMouseEnter={(e) => e.currentTarget.style.opacity = '0.8'} onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>Contact Page</a></li>
